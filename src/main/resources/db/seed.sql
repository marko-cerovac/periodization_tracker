...
INSERT INTO `sets` (`number_of_repetitions`, `rest_duration`, `weight`, `rpe`, `block`, `exercise_id`, `repetition_type_id`, `session_id`) VALUES
  -- anatoly: Clean&Jerk strength session
  (2, 120, 100, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Clean&Jerk'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Clean&Jerk strength session')),
  (2, 120, 110, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Clean&Jerk'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Clean&Jerk strength session')),
  (2, 120, 120, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Clean&Jerk'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Clean&Jerk strength session')),
  (3, 90, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Front Squat'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Clean&Jerk strength session')),
  (3, 90, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Front Squat'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Clean&Jerk strength session')),
  -- Snatch technique session
  (3, 90, 60, 5, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch'), @intentional_rep, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch technique session')),
  (3, 90, 70, 5, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch'), @intentional_rep, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch technique session')),
  (3, 90, 75, 6, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch'), @intentional_rep, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch technique session')),
  (5, 60, NULL, 4, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch Pull'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch technique session')),
  (5, 60, NULL, 4, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch Pull'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch technique session')),
  (5, 60, NULL, 4, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch Pull'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch technique session')),
  -- piros: Bench press day
  (5, 180, 130, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  (5, 180, 135, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  (5, 180, 140, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  (8, 120, 110, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Incline Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  (8, 120, 110, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Incline Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  (10, 90, 90, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  (10, 90, 90, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  (12, 60, NULL, 5, 4, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Push up'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  (12, 60, NULL, 5, 4, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Push up'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Bench press day')),
  -- vasily: Tempo run session
  (1, 600, NULL, 5, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Running'), @intentional_rep, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Tempo run session')),
  (6, 90, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Running'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Tempo run session')),
  (6, 90, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Running'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Tempo run session')),
  -- asen: Push day
  (4, 120, 80, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  (4, 120, 80, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  (4, 120, 80, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  (8, 90, 60, 6, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  (10, 90, 50, 5, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Overhead Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  (10, 90, 50, 5, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Overhead Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  (10, 90, 50, 5, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Overhead Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  (12, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Lateral Raise'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  (12, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Lateral Raise'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Push day')),
  -- valerios: Box jump session
  (5, 180, NULL, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Box Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Box jump session')),
  (5, 180, NULL, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Box Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Box jump session')),
  (5, 180, NULL, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Box Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Box jump session')),
  (8, 120, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Front Squat'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Box jump session')),
  (8, 120, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Front Squat'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Box jump session')),
  (8, 120, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Front Squat'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Box jump session')),
  -- naim: Chest and Triceps
  (8, 120, 100, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (8, 120, 100, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (8, 120, 100, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (8, 120, 100, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (10, 90, 80, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Incline Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (10, 90, 80, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Incline Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (10, 90, 80, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Incline Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (12, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Curl'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (12, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Curl'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  (15, 45, NULL, 4, 4, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Push up'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Chest and Triceps')),
  -- Pull day
  (6, 120, NULL, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Pull up'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Pull day')),
  (6, 120, NULL, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Pull up'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Pull day')),
  (6, 120, NULL, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Pull up'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Pull day')),
  (8, 90, 100, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bent Over Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Pull day')),
  (8, 90, 100, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bent Over Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Pull day')),
  (8, 90, 100, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bent Over Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Pull day')),
  (10, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Pull day')),
  (10, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Pull day')),
  -- Leg day
  (5, 180, 150, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Leg day')),
  (5, 180, 150, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Leg day')),
  (5, 180, 150, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Leg day')),
  (8, 120, 120, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Romanian Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Leg day')),
  (8, 120, 120, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Romanian Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Leg day')),
  (8, 120, 120, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Romanian Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Leg day')),
  (10, 90, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bodyweight Lunge'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Leg day')),
  (10, 90, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bodyweight Lunge'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Leg day')),
  -- Deadlift day
  (3, 180, 200, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Deadlift day')),
  (3, 180, 210, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Deadlift day')),
  (3, 180, 220, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Deadlift day')),
  (5, 120, 180, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Deadlift day')),
  (5, 120, 180, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Deadlift day')),
  (5, 120, 180, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Deadlift day')),
  (6, 90, 150, 6, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Trap Bar Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Deadlift day')),
  (6, 90, 150, 6, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Trap Bar Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Deadlift day')),
  -- Running (long run)
  (1, 1800, NULL, 4, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Running'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Long run session')),
  -- Plyometric session
  (6, 180, NULL, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Box Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Plyometric session')),
  (6, 180, NULL, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Box Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Plyometric session')),
  (8, 120, NULL, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Broad Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Plyometric session')),
  (8, 120, NULL, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Broad Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Plyometric session')),
  -- Cardio and core session
  (1, 900, NULL, 5, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Running'), @intentional_rep, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Cardio and core session')),
  (10, 120, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Burpee'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Cardio and core session')),
  (10, 120, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Burpee'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Cardio and core session')),
  (20, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Plank'), @isometric_rep, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Cardio and core session')),
  -- HIIT session
  (8, 60, 60, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Jump Rope'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'HIIT session')),
  (8, 60, 60, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Jump Rope'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'HIIT session')),
  (6, 60, NULL, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Box Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'HIIT session')),
  (6, 60, NULL, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Box Jump'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'HIIT session')),
  (10, 45, NULL, 6, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bodyweight Squat'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'HIIT session')),
  (10, 45, NULL, 6, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bodyweight Squat'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'HIIT session')),
  -- Rowing endurance session
  (1, 1200, NULL, 5, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Rowing'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Rowing endurance session')),
  (8, 120, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Rowing'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Rowing endurance session')),
  (8, 120, NULL, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Rowing'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Rowing endurance session')),
  -- Snatch max effort session
  (2, 150, 85, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch max effort session')),
  (2, 150, 90, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch max effort session')),
  (2, 150, 95, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch max effort session')),
  (5, 90, 70, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch Pull'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch max effort session')),
  (5, 90, 70, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Snatch Pull'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Snatch max effort session')),
  -- Heavy squat session
  (6, 180, 160, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Heavy squat session')),
  (6, 180, 165, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Heavy squat session')),
  (6, 180, 170, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Heavy squat session')),
  (4, 120, 150, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Pause Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Heavy squat session')),
  (4, 120, 150, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Pause Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Heavy squat session')),
  -- Max effort bench session
  (3, 180, 120, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort bench session')),
  (3, 180, 125, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort bench session')),
  (3, 180, 130, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort bench session')),
  (5, 120, 100, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Pin Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort bench session')),
  (5, 120, 100, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Pin Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort bench session')),
  -- Max effort deadlift session
  (2, 180, 220, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort deadlift session')),
  (2, 180, 230, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort deadlift session')),
  (2, 180, 240, 9, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort deadlift session')),
  (5, 120, 200, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deficit Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort deadlift session')),
  (5, 120, 200, 7, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deficit Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Max effort deadlift session')),
  -- Power clean session
  (5, 120, 90, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Power Clean'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Power clean session')),
  (5, 120, 95, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Power Clean'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Power clean session')),
  (5, 120, 100, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Power Clean'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Power clean session')),
  (6, 90, 70, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Clean Pull'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Power clean session')),
  (6, 90, 70, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Clean Pull'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Power clean session')),
  -- Romanian deadlift session
  (8, 120, 120, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Romanian Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Romanian deadlift session')),
  (8, 120, 125, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Romanian Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Romanian deadlift session')),
  (8, 120, 125, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Romanian Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Romanian deadlift session')),
  -- Back and Biceps
  (6, 120, 110, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bent Over Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  (6, 120, 110, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bent Over Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  (6, 120, 110, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bent Over Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  (6, 120, 110, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bent Over Row'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  (10, 90, 70, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Lat Pulldown'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  (10, 90, 70, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Lat Pulldown'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  (10, 90, 70, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Lat Pulldown'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  (12, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Curl'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  (12, 60, NULL, 5, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Dumbbell Curl'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Back and Biceps')),
  -- Tempo run
  (1, 600, NULL, 6, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Running'), @intentional_rep, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Tempo run session')),
  (3, 120, NULL, 5, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Running'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Tempo run session')),
  (3, 120, NULL, 5, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Running'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Tempo run session')),
  -- Kettlebell session
  (8, 90, 24, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Kettlebell Swing'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Kettlebell session')),
  (8, 90, 24, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Kettlebell Swing'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Kettlebell session')),
  (8, 90, 24, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Kettlebell Swing'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Kettlebell session')),
  (6, 120, 32, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Kettlebell Snatch'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Kettlebell session')),
  (6, 120, 32, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Kettlebell Snatch'), @fast_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Kettlebell session')),
  -- Shoulders and Traps
  (8, 120, 80, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Overhead Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Shoulders and Traps')),
  (8, 120, 80, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Overhead Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Shoulders and Traps')),
  (8, 120, 80, 7, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Overhead Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Shoulders and Traps')),
  (6, 120, 100, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Shoulders and Traps')),
  (6, 120, 100, 6, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Shoulders and Traps')),
  -- Full body strength session
  (5, 180, 150, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Full body strength session')),
  (5, 180, 150, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Full body strength session')),
  (5, 180, 150, 8, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Back Squat'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Full body strength session')),
  (5, 180, 130, 8, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Full body strength session')),
  (5, 180, 130, 8, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Full body strength session')),
  (5, 180, 130, 8, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Bench Press'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Full body strength session')),
  (5, 180, 180, 8, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Full body strength session')),
  (5, 180, 180, 8, 3, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Deadlift'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Full body strength session')),
  -- Swimming
  (6, 120, NULL, 6, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Swimming'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Swim technique session')),
  (6, 120, NULL, 6, 1, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Swimming'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Swim technique session')),
  (8, 90, NULL, 5, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Swimming'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Swim technique session')),
  (8, 90, NULL, 5, 2, (SELECT `exercise_id` FROM `exercises` WHERE `name` = 'Swimming'), @slow_rep_id, (SELECT `session_id` FROM `sessions` WHERE `name` = 'Swim technique session'));
